...
class Project(Base):
    ...
    # Repository icon code (1..30) shown in lists and headers: ten glyphs in
    # three colour tones, mapped number->glyph/tone by the frontend. Server-
    # assigned at random when creation omits it, so each project has a
